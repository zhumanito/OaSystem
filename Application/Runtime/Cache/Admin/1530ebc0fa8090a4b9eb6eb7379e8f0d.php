...
<div class="main">
    ...
    <p class="short-input ue-clear">
    	<label>内容：</label>
        <script id="editor" name="content" type="text/plain" style="width:800px;height:300px;"><?php echo (htmlspecialchars_decode($data["content"])); ?></script>
    </p>
</div>
...
<script type="text/javascript" src="/Public/plugin/ue/ueditor.config.js"></script>
<script type="text/javascript" src="/Public/plugin/ue/ueditor.all.min.js"></script>
<script type="text/javascript" src="/Public/plugin/ue/lang/zh-cn/zh-cn.js"></script>
