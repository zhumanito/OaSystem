...
<link rel="stylesheet" href="/Public/css/info-mgt.css" />
	...
	<table>
        ...
        <tbody>
        	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
				...
				<td class="file"><img src="<?php echo ($vol["thumb"]); ?>" /><?php if(!empty($vol["picture"])): ?>【<a href="/index.php/Admin/Knowledge/download/id/<?php echo ($vol["id"]); ?>">下载</a>】<?php endif; ?></td>
                <td class="content"><?php echo (substr($vol["content"],0,6)); ?></td>
...
<script type="text/javascript" src="__PUBILC__/js/jquery.js"></script>
