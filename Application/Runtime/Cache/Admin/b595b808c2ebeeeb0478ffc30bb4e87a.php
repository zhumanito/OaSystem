  ...
  <div id="hd">
    <div class="hd-wrap ue-clear">
      ...
      <div class="login-info ue-clear">
        ...
        <div class="login-msg ue-clear"> <a href="<?php echo U('Email/receiveBox');?>" 
        class="msg-txt" target="iframe">消息</a> <a href="<?php echo U('Email/receiveBox');?>" class="msg-num" target="iframe">0</a> </div>
      </div>
          ...
          <li class="email">
            ...
            <ul class="subnav">
              ...
              <li><a href="javascript:;" date-src="<?php echo U('Email/sendBox');?>">发件箱</a></li>
               <li><a href="javascript:;" date-src="<?php echo U('Email/receiveBox');?>">收件箱</a></li>
            </ul>
          </li>
          <li class="system">
